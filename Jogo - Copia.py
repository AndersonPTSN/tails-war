...
def check(x,y,jogador_da_vez):
    ...
    if (x >= 0 and x <= 24) and (y >=0 and y <=24):
        ...
        if mapa_com_personagens[x,y].tipo_bloco      == 22 and  m == 1 and mapa_com_personagens[jogador_da_vez.make_a_acao[0],jogador_da_vez.make_a_acao[1]].tipo_personagem == 0: # == pix_forte_vermelha:
